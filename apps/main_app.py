"""
Central Hub Application for Random Field Analysis Tools
=======================================================
This is the main entry point for all Random Field modeling applications.
...
app = Dash(
    ...
    title="Random Field Analysis Hub"
)

# Import all pages to register them AFTER app instantiation
from pages import home, rf_visualization, foundation_analysis, pile_analysis
...
sidebar = html.Div([
    html.H2("RF Analysis Hub", style={"color": "#007bff", "marginBottom": "2rem"}),
