...
from src.settlement.utils import plot_predictions
...
def create_plotly_figure(predictions_data, time_key, true_cv=2.3*1e-8 * (24 * 3_600)):
    ...
    fig.update_layout(
        ...
        legend=dict(
            x=0.40,  # Within the left subplot (which goes from 0 to ~0.75)
...
app.layout = html.Div([
    ...
    html.Div([
        dcc.Graph(id='settlement-plot', style={'height': '600px'})
    ], style={'margin': '20px'}),
